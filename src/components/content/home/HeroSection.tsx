               ...
               <Flex justify="end">
                      ...
                      <Box w="full" py="8">
                          <Stack direction={['column', 'row']} spacing="4">
                              <Box w={['100%', '75%']}>
                                <Input fontSize="14px" fontWeight="medium" placeholder='Enter VIN Number' color="skyBlue"  focusBorderColor="skyBlue" letterSpacings="widest" textTransform="uppercase"/>
                              </Box>
                              <Box>
